...
INSERT INTO jobs (title, description, location, job_type, created_at, salary_range, company_id)
VALUES
    ('Software Engineer', 'Develop and maintain web applications.', 'San Francisco, CA', 'Full-time', CURRENT_TIMESTAMP, 120000, 1),
    ('Project Manager', 'Lead project teams to successful outcomes.', 'Berlin, Germany', 'Contract', CURRENT_TIMESTAMP, 90000, 2),
    ('Data Analyst', 'Analyze and interpret complex data sets.', 'Remote', 'Part-time', CURRENT_TIMESTAMP, 60000, 3),
    ('Marketing Specialist', 'Develop and execute marketing strategies.', 'New York, NY', 'Full-time', CURRENT_TIMESTAMP, 75000, 4)
